...
export default {
  ...
  created() {
    info().then(response => {
      this.userTotal = response.data.data.userTotal || 0
      this.goodsTotal = response.data.data.goodsTotal || 0
      this.productTotal = response.data.data.productTotal || 0
      this.orderTotal = response.data.data.orderTotal || 0
    })
  },
  methods: {
